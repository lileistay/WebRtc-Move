...
export default {
	...
	methods: {
		...
		setConversationAvatarHandler(conversation) {
			...
			if (conversation.type === 'C2C') {
				return conversation.userProfile.avatar || 'http://thirdqq.qlogo.cn/qqopen/ONzCuQ9UVnn7OInbmjicc8IvpzR3V1dmicbZWBZ85U10IdbIs2QSfAuKTgGEq7GOKR/40?v=d95e';
			}
		...
		handleImageError() {
			this.setData({
				setConversationAvatar: 'http://thirdqq.qlogo.cn/qqopen/ONzCuQ9UVnn7OInbmjicc8IvpzR3V1dmicbZWBZ85U10IdbIs2QSfAuKTgGEq7GOKR/40?v=d95e'
			});
		}
	}
};
