...
/**  音乐文件播放状态改变的原因。在 localAudioMixingStateDidChanged 回调中报告。
 ...
 @since 4.3.0.0
 */
typedef NS_ENUM(NSInteger, ARAudioMixingReasonCode) {
  /** 701: 音乐文件打开出错。例如，本地音乐文件不存在、文件格式不支持或无法访问在线音乐文件 URL。
   */
  ARAudioMixingReasonCanNotOpen = 701,
  /** 702: 音乐文件打开太频繁。如需多次调用 startAudioMixing，请确保调用间隔大于 500 ms。
   */
  ARAudioMixingReasonTooFrequentCall = 702,
  /** 703: 音乐文件播放中断。
   */
  ARAudioMixingReasonInterruptedEOF = 703,
  /** 720: 成功调用 startAudioMixing 播放音乐文件。
   */
  ARAudioMixingReasonStartedByUser = 720,
  /** 721: 音乐文件完成一次循环播放。
   */
  ARAudioMixingReasonOneLoopCompleted = 721,
  /** 722: 音乐文件开始新的一次循环播放。
   */
  ARAudioMixingReasonStartNewLoop = 722,
  /** 723: 音乐文件完成所有循环播放。
   */
  ARAudioMixingReasonAllLoopsCompleted = 723,
  /** 724: 成功调用 stopAudioMixing 停止播放音乐文件。
   */
  ARAudioMixingReasonStoppedByUser = 724,
  /** 725: 成功调用 pauseAudioMixing 暂停播放音乐文件。
   */
  ARAudioMixingReasonPausedByUser = 725,
  /** 726: 成功调用 resumeAudioMixing 恢复播放音乐文件。
   */
  ARAudioMixingReasonResumedByUser = 726,
};
...
typedef NS_ENUM(NSInteger, ARNetworkType) {
    ...
    /**
     6:网络类型为 5G 移动网络
     @since 4.3.0.0  iOS 14.1以上
     */
    ARNetworkTypeMobile5G = 6
};
...
/** 声道模式。
 在 setAudioMixingDualMonoMode 中设置。
 */
typedef NS_ENUM(NSUInteger, ARAudioMixingDualMonoMode) {
  /** 0: 原始模式。
   */
  ARAudioMixingDualMonoAuto,
  /** 1: 左声道模式。该模式用左声道的音频替换右声道的音频，即用户只能听到左声道的音频。
   */
  ARAudioMixingDualMonoL,
  /** 2: 右声道模式。该模式用右声道的音频替换左声道的音频，即用户只能听到右声道的音频。
   */
  ARAudioMixingDualMonoR,
  /** 3: 混合模式。该模式将左右声道的数据叠加，即用户能同时听到左声道和右声道的音频。
   */
  ARAudioMixingDualMonoMix
};
